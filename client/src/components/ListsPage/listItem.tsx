...
const ListItem: React.FC<ListItemProps> = ({ list, remove }) => {
  ...
  return (
    <div className="pl-4 flex justify-between items-center w-11/12 p-2">
      <ListEditForm listName={listName} setListName={setListName} handleUpdate={handleUpdate} />
      <div className="relative">
        ...
        {showPopup && (
          <ListPopup handleClosePopup={() => setShowPopup(false)} handleRemove={handleRemove} />
        )}
      </div>
    </div>
  );
