...
const App = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url(https://trello-backgrounds.s3.amazonaws.com/SharedBackground/1440x1920/8ba59a04139f08c9b299da15599f895f/photo-1712291003261-5b3b5cea3f28.jpg)',
      }}
    >
      <Router>
        <MyNavbar />

        <BoardsModal onOpenChange={setBoardsModalOpen} />
